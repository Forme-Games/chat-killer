...
export declare type LikeContextType = 'like';
export declare type LikeContextSubType = 'like_add' | 'like_remove';
...
export declare type LikeContextOptions<S> = ContextFactoryOptions<ILikeContextPayload, S>;
