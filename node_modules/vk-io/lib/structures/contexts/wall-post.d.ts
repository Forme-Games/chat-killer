...
export declare type WallPostContextType = 'wall_post';
export declare type WallPostContextSubType = 'wall_post_new' | 'wall_repost';
export interface IWallPostContextPayload extends IWallAttachmentPayload {
}
export declare type WallPostContextOptions<S> = ContextFactoryOptions<IWallPostContextPayload, S>;
