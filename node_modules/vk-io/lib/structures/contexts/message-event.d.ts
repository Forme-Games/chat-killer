...
export declare type MessageEventAction = IMessageEventShowSnackbar | IMessageEventOpenLink | IMessageEventOpenApp;
export declare type MessageEventContextType = 'message_event';
export declare type MessageEventContextSubType = 'message_event';
...
export declare type MessageEventContextOptions<S> = ContextFactoryOptions<IMessageEventContextPayload, S>;
