...
export declare type MessagesReadContextType = 'messages_read';
export declare type MessagesReadContextSubType = 'messages_read_inbox' | 'messages_read_outbox';
export interface IMessagesReadContextPayload {
    peer_id: number;
    local_id: number;
}
export declare type MessagesReadContextContextOptions<S> = ContextFactoryOptions<number[], S>;
