...
export declare type VoteContextType = 'vote';
export declare type VoteContextSubType = 'poll_vote_new';
...
export declare type VoteContextOptions<S> = ContextFactoryOptions<IVoteContextPayload, S>;
