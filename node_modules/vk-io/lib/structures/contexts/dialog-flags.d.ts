...
export declare type DialogFlagsContextType = 'dialog_flags';
export declare type DialogFlagsContextSubType = 'dialog_flags_replace' | 'dialog_flags_add' | 'dialog_flags_delete';
...
export declare type DialogFlagsContextOptions<S> = ContextFactoryOptions<number[], S>;
