...
export declare type GroupUpdateContextType = 'group_update';
export declare type GroupUpdateContextSubType = 'group_change_photo' | 'group_officers_edit' | 'group_change_settings';
...
export declare type GroupUpdateContextOptions<S> = ContextFactoryOptions<IGroupUpdateContextPayload, S>;
