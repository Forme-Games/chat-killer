...
export declare type MarketOrderContextType = 'market_order';
export declare type MarketOrderContextSubType = 'market_order_new' | 'market_order_edit';
...
export declare type MarketOrderContextOptions<S> = ContextFactoryOptions<IMarketOrderContextPayload, S>;
