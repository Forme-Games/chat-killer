...
export declare type VKPayTransactionContextType = 'vk_pay_transaction';
export declare type VKPayTransactionContextSubType = 'vkpay_transaction';
...
export declare type VKPayTransactionContextOptions<S> = ContextFactoryOptions<IVKPayTransactionPayload, S>;
