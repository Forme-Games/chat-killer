...
export declare type NewAttachmentsContextType = 'new_attachment';
export declare type NewAttachmentsContextSubType = 'photo_new' | 'video_new' | 'audio_new';
export interface INewAttachmentsContextPayload {
    id: number;
}
export declare type NewAttachmentsContextOptions<S> = ContextFactoryOptions<INewAttachmentsContextPayload, S>;
