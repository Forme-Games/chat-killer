...
export declare type IExternalAttachmentOptions<P, Type extends string = string> = IAttachmentOptions<P, Type>;
export declare type ExternalAttachmentFactoryOptions<P> = AttachmentFactoryOptions<P>;
