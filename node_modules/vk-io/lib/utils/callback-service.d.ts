...
export declare type CallbackServiceRetry = (code: Error | string) => Promise<void>;
export declare type CaptchaHandler = (payload: ICallbackServiceCaptchaPayload, retry: CallbackServiceRetry) => Promise<void> | void;
export declare type TwoFactorHandler = (payload: ICallbackServiceTwoFactorPayload, retry: CallbackServiceRetry) => Promise<void> | void;
